...
/// backend (WebbyChat). This is the "complete" example, so it exercises every
/// feature the README describes that XCUITest can drive: fresh connect,
/// greeting + suggestion pills, tapping a suggestion, markdown/link formatting,
/// the attachment carousel, and start-new. (Live-agent handoff is covered by
/// ChatSessionTests — see the note above test_startNewConversation.)
///
