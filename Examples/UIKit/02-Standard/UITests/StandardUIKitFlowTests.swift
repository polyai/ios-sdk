...
/// End-to-end XCUITests for the standard UIKit app. 02 introduces the "80% app"
/// surface, so this covers the features its README describes: greeting +
/// suggestion pills (typing throttle, delivery dots) and the
/// End -> Start New Conversation flow.
///
