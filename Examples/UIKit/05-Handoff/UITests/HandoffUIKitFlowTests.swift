...
/// End-to-end XCUITests for the handoff UIKit app. 05 is a "complete" example,
/// so it exercises every feature its README (and the levels it builds on)
/// describes: greeting + suggestion pills, tapping a suggestion, markdown/link
/// formatting, the attachment carousel, the live-agent handoff flow
/// (Transferring…), and End -> Start New Conversation.
///
