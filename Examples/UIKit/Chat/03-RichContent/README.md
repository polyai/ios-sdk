...
Adds image attachments, URL link cards, `tel:` call actions, and Markdown rendering on top of [`02-Standard`](../02-Standard/). The UIKit twin of [`Examples/SwiftUI/03-RichContent/`](../../../SwiftUI/Chat/03-RichContent/).
...
- **SwiftUI counterpart:** [`Examples/SwiftUI/03-RichContent/`](../../../SwiftUI/Chat/03-RichContent/)
