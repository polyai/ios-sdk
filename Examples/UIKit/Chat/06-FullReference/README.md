...
### In-app new-message banners (local workaround) — `Views/ChatViewController.swift`, `Components/NewMessageNotifier.swift`
...
- **SwiftUI counterpart:** [`Examples/SwiftUI/06-FullReference/`](../../../SwiftUI/Chat/06-FullReference/)
