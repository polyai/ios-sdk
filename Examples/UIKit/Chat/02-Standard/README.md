...
The 80% chat in UIKit — adds typing indicator, connection banner, suggestion pills, delivery state (`Sending…` + failed retry), end + start new chat, and a failure overlay on top of [`01-Hello`](../01-Hello/). The UIKit twin of [`Examples/SwiftUI/02-Standard/`](../../../SwiftUI/Chat/02-Standard/).
...
- **SwiftUI counterpart:** [`Examples/SwiftUI/02-Standard/`](../../../SwiftUI/Chat/02-Standard/)
