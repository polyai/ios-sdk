...
The smallest possible chat in UIKit + Storyboard — initialize the SDK, render messages in a table, send one. The UIKit twin of [`Examples/SwiftUI/01-Hello/`](../../../SwiftUI/Chat/01-Hello/).
...
- **SwiftUI counterpart:** [`Examples/SwiftUI/01-Hello/`](../../../SwiftUI/Chat/01-Hello/)
