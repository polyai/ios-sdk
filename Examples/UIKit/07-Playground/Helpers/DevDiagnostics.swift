//  DevDiagnostics.swift
//  Examples/UIKit/07-Playground
//
//  Lightweight counters / live state for socket + protocol experiments.
//  Ported from the SwiftUI 07 helper — an ObservableObject whose @Published
//  values UIKit observes via Combine (`$framesIn.sink`, `objectWillChange`).
//
