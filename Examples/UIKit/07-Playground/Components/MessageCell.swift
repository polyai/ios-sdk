...
//  mirroring the SwiftUI 06 ChatBubbleView.
//
...
final class MessageCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        // scrolls) — same card as the image carousel, just filtered to .url.
        ...
        // a definite content width so they actually show. The two carousels use an
        // optional priority so the pin yields to the stack's hide-collapse when the
        // message has no attachments of that kind.
