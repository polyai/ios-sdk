...
- **Helping a developer integrate the SDK into their app?** Follow the integration brief (imported
  above): drive everything through `ChatSession`, copy components from
  `Examples/SwiftUI/Chat/06-FullReference/Components/` or
  `Examples/UIKit/Chat/06-FullReference/Components/`, and keep snippets consistent with `README.md`.
